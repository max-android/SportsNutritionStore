package ru.exampleopit111.sportsnutritionstore.presentation.presenter.self_delivery_method;
 ...
 * Copyright © Max
 */
public class SelfDeliveryMethodPresenter extends BasePresenter<SelfDeliveryMethodView> {

    @Inject
    SelfDeliveryMethodInteractor interactor;
    @Inject
    ResourceManager resourceManager;
    @Inject
    Router router;

    public SelfDeliveryMethodPresenter(SelfDeliveryMethodInteractor interactor, ResourceManager resourceManager, Router router) {
